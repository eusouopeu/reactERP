...
function somaSalarios(staffData: Array<{ [key: string]: any }>): {
	...
	staffData.forEach((item) => {
		if (item['remuneracaoBasicaBruta'] != null) {
			const remuneration = parseRemuneracao(
				item['remuneracaoBasicaBruta'].toString(),
			)
...
const mediaSalariosTotal = (
	staffData: Array<{ remuneracaoBasicaBruta: string }>,
): number => {
...
const mediaSalariosProfs = (
	staffData: Array<{ cargo: string; remuneracaoBasicaBruta: string }>,
): number => {
