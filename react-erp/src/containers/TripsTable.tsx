...
export default function TripTable() {
  ...
  const onChange: TableProps<TripModel>['onChange'] = (pagination, filters, sorter, extra) => {
    console.log('params', pagination, filters, sorter, extra)
  }

  const getColumnSearchProps = (dataIndex: DataIndex): TableColumnType<TripModel> => ({
  ...
  const receiptsTableHeader: TableColumnsType<TripModel> = [
    ...
    },
    {
      ...
      render: (_, { cargo }) => (
        cargo === 'Professor' ?
          ...
          <Tag color='geekblue' key={cargo}>
            {cargo}
          </Tag> : cargo === 'Estagiário' ?
          <Tag color='green' key={cargo}>
            {cargo}
          </Tag> : null
      ),
      filterSearch: true,
    ...
    },
    {
      ...
      sorter: {
        compare: (a: TripModel, b: TripModel) => parseFloat(a.valorTotal.replace('R$ ', '').replace('.','').replace(',', '.')) - parseFloat(b.valorTotal.replace('R$ ', '').replace('.','').replace(',', '.')),
      },
    },
  ]
