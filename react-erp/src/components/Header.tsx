...
import { MagnifyingGlassIcon, HomeIcon, CurrencyDollarIcon, UsersIcon } from '@heroicons/react/20/solid'
...
export default function Header() {
  ...
  return (
    <header className='
      absolute bottom-[0px] md:left-[0px] flex items-center
      h-[80px] md:h-screen w-full md:w-[280px] p-[16px]
    '>
