...
export default function EnhancedTable() {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }} className='bg-blue-500' >
        <EnhancedTableToolbar numSelected={selected.length}/>
        <TableContainer className='*:odd:bg-blue'>
          <Table
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.admissao}</TableCell>
                      <TableCell align="left">R$ {formatNumber(row.salario, "pt-BR")}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
